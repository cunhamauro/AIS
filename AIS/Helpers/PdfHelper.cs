...
namespace AIS.Helpers
{
    public class PdfHelper : IPdfHelper
    {
        ...
        public MemoryStream GenerateTicketPdf(string nameWithTitle, string idNumber, string flightNumber, string originCityCountry, string destinationCityCountry, string seat, DateTime departure, DateTime arrival, MemoryStream qrCode)
        {
            ...
            gfx.DrawString($"DESTINATION: {destinationCityCountry}", fontText, XBrushes.Black, new XRect(50, 280, page.Width - 100, 40), XStringFormats.TopLeft);
            gfx.DrawString($"DEPARTURE: {departure:dd MMM yyyy HH:mm}", fontText, XBrushes.Black, new XRect(50, 320, page.Width - 100, 40), XStringFormats.TopLeft);
            gfx.DrawString($"ARRIVAL: {arrival:dd MMM yyyy HH:mm}", fontText, XBrushes.Black, new XRect(50, 360, page.Width - 100, 40), XStringFormats.TopLeft);
            gfx.DrawString($"SEAT: {seat}", fontText, XBrushes.Black, new XRect(50, 400, page.Width - 100, 40), XStringFormats.TopLeft);
            gfx.DrawString($"BOARDING TIME: {boardingTime:HH:mm}", fontText, XBrushes.Black, new XRect(50, 440, page.Width - 100, 40), XStringFormats.TopLeft);

            // Draw a line to separate
            gfx.DrawLine(XPens.Black, 50, 480, page.Width - 50, 480);

            // Add some extra text
            gfx.DrawString("Enjoy your flight!", fontText, XBrushes.Black, new XRect(50, 500, page.Width - 100, 40), XStringFormats.TopLeft);
            gfx.DrawString("Aero Info System - AIS", fontText, XBrushes.DodgerBlue, new XRect(50, 540, page.Width - 100, 40), XStringFormats.TopLeft);

            // Draw a blue border around the page
            var borderPen = new XPen(XColors.DodgerBlue, 7);
            gfx.DrawRectangle(borderPen, 25, 25, page.Width - 50, page.Height - 50); // Draw rectangle with margin

            // Load the QR code image from the MemoryStream
            qrCode.Position = 0;
            XImage qrCodeImage = XImage.FromStream(qrCode);
            gfx.DrawImage(qrCodeImage, page.Width / 2 - 80, 590, 160, 160); // Example position and size
        ...
        public MemoryStream GenerateInvoicePdf(string name, string flightNumber, decimal price, bool userCancel, bool flightCancel)
        {
            ...
            // Draw a line to separate
            gfx.DrawLine(XPens.Black, 50, 310, page.Width - 50, 310);

            gfx.DrawString($"CLIENT: {name}", fontText, XBrushes.Black, new XRect(50, 170, page.Width - 100, 40), XStringFormats.TopLeft);
            gfx.DrawString($"PRICE: {price:C2}", fontText, XBrushes.Black, new XRect(50, 220, page.Width - 100, 40), XStringFormats.TopLeft);

            if (userCancel || flightCancel)
            {
                gfx.DrawString($"DATE OF CANCEL: {DateTime.UtcNow}", fontText, XBrushes.Black, new XRect(50, 270, page.Width - 100, 40), XStringFormats.TopLeft);
            }
            else
            {
                gfx.DrawString($"DATE OF PURCHASE: {DateTime.UtcNow}", fontText, XBrushes.Black, new XRect(50, 270, page.Width - 100, 40), XStringFormats.TopLeft);
            }
            ...
            if (userCancel)
            {
                gfx.DrawString($"REFUNDED VALUE: {price / 4:C2}", fontText, XBrushes.Black, new XRect(50, 330, page.Width - 100, 40), XStringFormats.TopLeft);

                // Add some extra text
                gfx.DrawString("We will miss you in this flight!", fontText, XBrushes.Black, new XRect(50, 360, page.Width - 100, 40), XStringFormats.TopLeft);
                gfx.DrawString("Aero Info System - AIS", fontText, XBrushes.DodgerBlue, new XRect(50, 400, page.Width - 100, 40), XStringFormats.TopLeft);
            }
            else if (flightCancel)
            {
                gfx.DrawString($"REFUNDED VALUE: {price:C2}", fontText, XBrushes.Black, new XRect(50, 330, page.Width - 100, 40), XStringFormats.TopLeft);

                // Add some extra text
                gfx.DrawString("We are very sorry for the flight cancel!", fontText, XBrushes.Black, new XRect(50, 360, page.Width - 100, 40), XStringFormats.TopLeft);
                gfx.DrawString("Aero Info System - AIS", fontText, XBrushes.DodgerBlue, new XRect(50, 400, page.Width - 100, 40), XStringFormats.TopLeft);
            }
            else
            {
                gfx.DrawString("Thank you for your purchase!", fontText, XBrushes.Black, new XRect(50, 350, page.Width - 100, 40), XStringFormats.TopLeft);
                gfx.DrawString("Aero Info System - AIS", fontText, XBrushes.DodgerBlue, new XRect(50, 390, page.Width - 100, 40), XStringFormats.TopLeft);
            }
